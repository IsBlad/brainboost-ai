...
# SYSTEM_MESSAGE = """
# Generate a JSON object for each word that includes its definition and an example sentence.
# The definitions and example sentences should be simple and easy to understand, suitable for CEFR {CEFR_LEVEL} learners.
...
# Ensure the language is clear and appropriate for the specified CEFR level.
# """
